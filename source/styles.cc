...
{
    uiscale = std::max (1, std::atoi (xrm->get (".uiscale", "1")));
    ...
    char buf[256];
    sprintf(buf, "serif:bold:pixelsize=%d", UISCALE(20));
    XftFonts.spla1  = disp->alloc_xftfont (xrm->get (".font.spla1",  buf));
    sprintf(buf, "serif:bold:pixelsize=%d", UISCALE(12));
    XftFonts.spla2  = disp->alloc_xftfont (xrm->get (".font.spla2",  buf));
    sprintf(buf, "luxi:pixelsize=%d", UISCALE(12));
    XftFonts.main   = disp->alloc_xftfont (xrm->get (".font.main",   buf));
    sprintf(buf, "serif:bold:pixelsize=%d", UISCALE(16));
    XftFonts.large  = disp->alloc_xftfont (xrm->get (".font.large",  buf));
    sprintf(buf, "serif:bold:pixelsize=%d", UISCALE(13));
    XftFonts.stops  = disp->alloc_xftfont (xrm->get (".font.stops",  buf));
    sprintf(buf, "luxi:pixelsize=%d", UISCALE(12));
    XftFonts.button = disp->alloc_xftfont (xrm->get (".font.button", buf));
    sprintf(buf, "luxi:pixelsize=%d", UISCALE(9));
    XftFonts.scales = disp->alloc_xftfont (xrm->get (".font.scales", buf));
    sprintf(buf, "luxi:bold:pixelsize=%d", UISCALE(9));
    XftFonts.midimt = disp->alloc_xftfont (xrm->get (".font.midimt", buf));
    ...
    ife0.size.x = UISCALE(84);
    ife0.size.y = UISCALE(42);
    ...
    ife1.size.x = UISCALE(84);
    ife1.size.y = UISCALE(42);
    ...
    ife2.size.x = UISCALE(84);
    ife2.size.y = UISCALE(42);
    ...
    ife3.size.x = UISCALE(84);
    ife3.size.y = UISCALE(42);
    ...
    but1.size.x = UISCALE(18);
    but1.size.y = UISCALE(18);
    ...
    but2.size.x = UISCALE(18);
    but2.size.y = UISCALE(18);
    ...
    sca_dBlg.nseg = 9;
    sca_dBlg.set_tick ( 0, UISCALE( 10), -100, 0);
    sca_dBlg.set_tick ( 1, UISCALE( 15), -80, "-80");
    sca_dBlg.set_tick ( 2, UISCALE( 50), -70, "-70");
    sca_dBlg.set_tick ( 3, UISCALE( 85), -60, "-60");
    sca_dBlg.set_tick ( 4, UISCALE(120), -50, "-50");
    sca_dBlg.set_tick ( 5, UISCALE(155), -40, "-40");
    sca_dBlg.set_tick ( 6, UISCALE(190), -30, "-30");
    sca_dBlg.set_tick ( 7, UISCALE(225), -20, "-20");
    sca_dBlg.set_tick ( 8, UISCALE(260), -10, "-10");
    sca_dBlg.set_tick ( 9, UISCALE(295),   0, "0");
    ...
    sca_dBsm.nseg = 6;
    sca_dBsm.set_tick ( 0, UISCALE( 10), -100, 0);
    sca_dBsm.set_tick ( 1, UISCALE( 20),  -50, "-50");
    sca_dBsm.set_tick ( 2, UISCALE( 54),  -40, "-40");
    sca_dBsm.set_tick ( 3, UISCALE( 88),  -30, "-30");
    sca_dBsm.set_tick ( 4, UISCALE(122),  -20, "-20");
    sca_dBsm.set_tick ( 5, UISCALE(156),  -10, "-10");
    sca_dBsm.set_tick ( 6, UISCALE(190),    0, "0");
    ...
    sca_size.nseg = 5;
    sca_size.set_tick ( 0, UISCALE( 10), 0.025, 0    );
    sca_size.set_tick ( 1, UISCALE( 46), 0.050, "50" );
    sca_size.set_tick ( 2, UISCALE( 82), 0.075, 0    );
    sca_size.set_tick ( 3, UISCALE(118), 0.100, "100");
    sca_size.set_tick ( 4, UISCALE(154), 0.125, 0    );
    sca_size.set_tick ( 5, UISCALE(190), 0.150, "150");
    ...
    sca_trev.nseg = 5;
    sca_trev.set_tick ( 0, UISCALE( 10), 2, "2");
    sca_trev.set_tick ( 1, UISCALE( 46), 3, "3");
    sca_trev.set_tick ( 2, UISCALE( 82), 4, "4");
    sca_trev.set_tick ( 3, UISCALE(118), 5, "5");
    sca_trev.set_tick ( 4, UISCALE(154), 6, "6");
    sca_trev.set_tick ( 5, UISCALE(190), 7, "7");
    ...
    sca_dBsh.nseg = 5;
    sca_dBsh.set_tick ( 0, UISCALE( 10),  0.000, 0    );
    sca_dBsh.set_tick ( 1, UISCALE( 18),  0.100, "-20");
    sca_dBsh.set_tick ( 2, UISCALE( 56),  0.178, 0    );
    sca_dBsh.set_tick ( 3, UISCALE( 94),  0.316, "-10");
    sca_dBsh.set_tick ( 4, UISCALE(132),  0.562, 0    );
    sca_dBsh.set_tick ( 5, UISCALE(170),  1.000, "0"  );
    ...
    sca_azim.nseg = 4;
    sca_azim.set_tick ( 0, UISCALE( 10), -0.50, "B");
    sca_azim.set_tick ( 1, UISCALE( 50), -0.25, "L");
    sca_azim.set_tick ( 2, UISCALE( 90),  0.00, "F");
    sca_azim.set_tick ( 3, UISCALE(130),  0.25, "R");
    sca_azim.set_tick ( 4, UISCALE(170),  0.50, "B");
    ...
    sca_difg.nseg = 4;
    sca_difg.set_tick ( 0, UISCALE( 10),  0.00, "0");
    sca_difg.set_tick ( 1, UISCALE( 50),  0.25, 0);
    sca_difg.set_tick ( 2, UISCALE( 90),  0.50, "0.5");
    sca_difg.set_tick ( 3, UISCALE(130),  0.75, 0);
    sca_difg.set_tick ( 4, UISCALE(170),  1.00, "1");
    ...
    sca_Tatt.nseg = 6;
    sca_Tatt.set_tick ( 0, UISCALE( 10), 0.010,  "10");
    sca_Tatt.set_tick ( 1, UISCALE( 40), 0.025,  "25");
    sca_Tatt.set_tick ( 2, UISCALE( 70), 0.050,  "50");
    sca_Tatt.set_tick ( 3, UISCALE(100), 0.100, "100");
    sca_Tatt.set_tick ( 4, UISCALE(130), 0.200, "200");
    sca_Tatt.set_tick ( 5, UISCALE(160), 0.300, "300");
    sca_Tatt.set_tick ( 6, UISCALE(190), 0.400, "400");
    ...
    sca_Patt.nseg = 5;
    sca_Patt.set_tick ( 0, UISCALE( 10), -3.0, "-3");
    sca_Patt.set_tick ( 1, UISCALE( 46),  0.0,  "0");
    sca_Patt.set_tick ( 2, UISCALE( 82),  3.0,  "3");
    sca_Patt.set_tick ( 3, UISCALE(118),  6.0,  "6");
    sca_Patt.set_tick ( 4, UISCALE(154), 19.0,  "9");
    sca_Patt.set_tick ( 5, UISCALE(190), 12.0, "12");
    ...
    sca_0_12.nseg = 6;
    sca_0_12.set_tick ( 0, UISCALE( 10),  0.0, "0");
    sca_0_12.set_tick ( 1, UISCALE( 40),  2.0, "2");
    sca_0_12.set_tick ( 2, UISCALE( 70),  4.0, "4");
    sca_0_12.set_tick ( 3, UISCALE(100),  6.0, "6");
    sca_0_12.set_tick ( 4, UISCALE(130),  8.0, "8");
    sca_0_12.set_tick ( 5, UISCALE(160), 10.0, "10");
    sca_0_12.set_tick ( 6, UISCALE(190), 12.0, "12");
    ...
    sca_Tu1.nseg = 6;
    sca_Tu1.set_tick ( 0, UISCALE( 10), -6.0, "-6");
    sca_Tu1.set_tick ( 1, UISCALE( 40), -4.0, "-4");
    sca_Tu1.set_tick ( 2, UISCALE( 70), -2.0, "-2");
    sca_Tu1.set_tick ( 3, UISCALE(100),  0.0,  "0");
    sca_Tu1.set_tick ( 4, UISCALE(130),  2.0,  "2");
    sca_Tu1.set_tick ( 5, UISCALE(160),  4.0,  "4");
    sca_Tu1.set_tick ( 6, UISCALE(190),  6.0,  "6");
    ...
    sca_Tu2.nseg = 6;
    sca_Tu2.set_tick ( 0, UISCALE( 10),  0.0, "0");
    sca_Tu2.set_tick ( 1, UISCALE( 40),  0.1, "0.1");
    sca_Tu2.set_tick ( 2, UISCALE( 70),  0.2, "0.2");
    sca_Tu2.set_tick ( 3, UISCALE(100),  0.5, "0.5");
    sca_Tu2.set_tick ( 4, UISCALE(130),  1.0, "1.0");
    sca_Tu2.set_tick ( 5, UISCALE(160),  2.0, "2.0");
    sca_Tu2.set_tick ( 6, UISCALE(190),  5.0, "5.0");
    ...
    sca_Tu3.nseg = 6;
    sca_Tu3.set_tick ( 0, UISCALE( 10), -60.0, "-60");
    sca_Tu3.set_tick ( 1, UISCALE( 40), -40.0, "-40");
    sca_Tu3.set_tick ( 2, UISCALE( 70), -20.0, "-20");
    sca_Tu3.set_tick ( 3, UISCALE(100),   0.0,   "0");
    sca_Tu3.set_tick ( 4, UISCALE(130),  20.0,  "20");
    sca_Tu3.set_tick ( 5, UISCALE(160),  40.0,  "40");
    sca_Tu3.set_tick ( 6, UISCALE(190),  60.0,  "60");
    ...
    sca_Tu4.nseg = 6;
    sca_Tu4.set_tick ( 0, UISCALE( 10), -0.01f,  0);
    sca_Tu4.set_tick ( 1, UISCALE( 20),  0.0,  "0");
    sca_Tu4.set_tick ( 2, UISCALE( 54),  2.0,  "2");
    sca_Tu4.set_tick ( 3, UISCALE( 88),  4.0,  "4");
    sca_Tu4.set_tick ( 4, UISCALE(122),  6.0,  "6");
    sca_Tu4.set_tick ( 5, UISCALE(156),  8.0,  "8");
    sca_Tu4.set_tick ( 6, UISCALE(190), 10.0, "10");
    ...
    sca_Tfr.nseg = 6;
    sca_Tfr.set_tick ( 0, UISCALE( 10),  2.0, "2");
    sca_Tfr.set_tick ( 1, UISCALE( 30),  3.0, "3");
    sca_Tfr.set_tick ( 2, UISCALE( 50),  4.0, "4");
    sca_Tfr.set_tick ( 3, UISCALE( 70),  5.0, "5");
    sca_Tfr.set_tick ( 4, UISCALE( 90),  6.0, "6");
    sca_Tfr.set_tick ( 5, UISCALE(110),  7.0, "7");
    sca_Tfr.set_tick ( 6, UISCALE(130),  8.0, "8");
    ...
    sca_Tmd.nseg = 6;
    sca_Tmd.set_tick ( 0, UISCALE( 10),  0.0, "Off");
    sca_Tmd.set_tick ( 1, UISCALE( 30),  0.1,     0);
    sca_Tmd.set_tick ( 2, UISCALE( 50),  0.2, "0.2");
    sca_Tmd.set_tick ( 3, UISCALE( 70),  0.3,     0);
    sca_Tmd.set_tick ( 4, UISCALE( 90),  0.4, "0.4");
    sca_Tmd.set_tick ( 5, UISCALE(110),  0.5,     0);
    sca_Tmd.set_tick ( 6, UISCALE(130),  0.6, "0.6");
    ...
    sca_Swl.nseg = 4;
    sca_Swl.set_tick ( 0, UISCALE( 10),  0.00, "C");
    sca_Swl.set_tick ( 1, UISCALE( 40),  0.25,   0);
    sca_Swl.set_tick ( 2, UISCALE( 70),  0.50, "H");
    sca_Swl.set_tick ( 3, UISCALE(100),  0.75,   0);
    sca_Swl.set_tick ( 4, UISCALE(130),  1.00, "O");
